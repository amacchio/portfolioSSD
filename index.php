...
<title>Anthony Macchio's Graphic Design Portfolio</title>
<link rel="stylesheet" href="chromeStyles01.css" type="text/css" media="screen" />
<link rel="stylesheet" href="fancybox/jquery.fancybox-1.3.4.css" type="text/css" media="screen" />
<link rel="canonical" href="http://www.amacchio.com" />
...
<script type="text/javascript" src="http://s7.addthis.com/js/300/addthis_widget.js#pubid=xa-4eee55f1539ec9fe"></script>
...
<div id="wrapper">
    ...
    <div id="navColumn">
        <div id="headerLogo">
        	<h1>Anthony Macchio: Advertising, Branding, and Web Design</h1> 
        </div><!--close headerLogo-->
        <div id="mainNav">
        	<ul>
            	<li class="selected"><a href="#" class="portLeft">Portfolio</a></li>
                <li><a href="about.html" class="aboutCenter">Resume</a></li>
                <li><a href="contact.html" class="contactRight">Contact</a></li>
            </ul>
        </div><!--close mainNav-->
        <div id="options">
        	<ul id="filters" class="option-set clearfix" data-option-key="filter">
            	<li><a href="#filter" data-option-value="*" class="selected">Show All</a></li>
                <li><a href="#filter" data-option-value=".3d">3D Renders</a></li>
            	<li><a href="#filter" data-option-value=".ad">Advertising</a></li>
                <li><a href="#filter" data-option-value=".brand">Branding</a></li>
                <li><a href="#filter" data-option-value=".motion" >Motion</a></li>
                <li><a href="#filter" data-option-value=".print">Print</a></li>
                <li><a href="#filter" data-option-value=".web">Web Design</a></li>
            </ul>
        </div><!--close portfolioNav-->
        <div id="footerStuff">
        	...
        	<h6>&copy; 2011 Anthony Macchio. All rights reserved.</h6>
        </div><!--close footerStuff-->
    </div><!--close navColumn-->
    
    <div class="detail">
    </div><!--close details-->

    <div id="thmbContainer">
        <div class="thmb brand">
        	<a href="#"><img src="images/thmbs/olympicThmb.jpg" width="346" height="155" /></a>
            <div class="description">
            	<h3><a href="#">2012 Olympic Logo Process</a></h3>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb print">
        	<a href="board.html"><img src="images/thmbs/boardThmb.jpg" width="346" height="155" /></a>
             <div class="description">
            	<h3><a href="board.html">Skateboard Deck</a></h3>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb brand web">
        	<a href="olympicSite.html"><img src="images/thmbs/olympicSiteThmb.jpg" width="346" height="155" /></a>
             <div class="description">
            	<h3><a href="olympicSite.html">2012 Olympic Web Design</a></h3>
            </div><!--close description-->
        </div><!--close thmb-->
         <div class="thmb print brand">
        	<a class="fancyBox" href="#"><img src="images/thmbs/luzianneThmb.jpg" width="346" height="155" /></a>
             <div class="description">
            	<a class="grouped_Elements" rel="luzinne" href="images/gallery/luzianne/lzMockEnvelopes.jpg"><h3>Luzianne Coffee &amp; Tea Rebrand</h3></a>
                <a class="grouped_Elements" rel="luzinne" href="images/gallery/luzianne/lzMockBox.jpg"></a>
                <a class="grouped_Elements" rel="luzinne" href="images/gallery/luzianne/lzMockAll.jpg"></a>
            </div><!--close description-->
        </div><!--close thmb-->    
        <div class="thmb brand web print">
        	<a href="level.html"><img src="images/thmbs/levelThmb.jpg" width="346" height="155" /></a>
             <div class="description">
            	<h3><a href="plights.html">Level Software Brand Identity</a></h3>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb 3d">
        	<a class="fancyBox" href="#"><img src="images/thmbs/dexterThmb.jpg" width="346" height="155" /></a>
             <div class="description">
            	<a class="grouped_Elements" rel="dexter" href="images/gallery/dexter/dexterFrame001.png"><h3>Dexter Morgan's 3D Living Room</h3></a>
                <a class="grouped_Elements" rel="dexter" href="images/gallery/dexter/dexterFrame002.png"></a>
                <a class="grouped_Elements" rel="dexter" href="images/gallery/dexter/dexterFrame003.png"></a>
                <a class="grouped_Elements" rel="dexter" href="images/gallery/dexter/dexterFrame004.png"></a>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb print ad">
        	<a class="fancyBox" href="#"><img src="images/thmbs/vuittonThmb.png" width="346" height="155" alt="Louis Vuitton Thumbnail" /></a>
             <div class="description">
            	<a class="grouped_Elements" rel="vuitton" href="images/gallery/vuitton/DogWalkDS.jpg"><h3>Louis Vuitton Ad Campaign</h3></a>
                <a class="grouped_Elements" rel="vuitton" href="images/gallery/vuitton/boardWalkDS.jpg"></a>
                <a class="grouped_Elements" rel="vuitton" href="images/gallery/vuitton/JayWalkDS.jpg"></a>
                <a class="grouped_Elements" rel="vuitton" href="images/gallery/vuitton/AllMags.jpg"></a>
                <a class="grouped_Elements" rel="vuitton" href="images/gallery/vuitton/BoardWalkiPad.jpg"></a>
                <a class="grouped_Elements" rel="vuitton" href="images/gallery/vuitton/LV_MallDisplay.jpg"></a>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb print">
        	<a class="fancyBox" href="#"><img src="images/thmbs/prettyThmb.jpg" width="346" height="155" alt="Pretty Lights Thumbnail" /></a>
             <div class="description">
            	
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb print">
        	<a class="fancyBox" href="#"><img src="images/thmbs/eventThmb.jpg" width="346" height="155" alt="Philippe Intraligi Poster Series Thumbnail" /></a>
             <div class="description">
            	<a class="grouped_Elements" rel="hero" href="images/gallery/eventPosters/intraligiMock001.jpg"><h3>Philippe Intraligi Poster Series</h3></a>
                <a class="grouped_Elements" rel="hero" href="images/gallery/eventPosters/intraligiMock002.jpg"></a>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb motion 3d">
        	<a href="ets.html"><img src="images/thmbs/etsThmb.png" width="346" height="155" /></a>
             <div class="description">
            	<h3><a href="ets.html">ets inc. Bumper</a></h3>
            </div><!--close description-->
        </div><!--close thmb-->
        <div class="thmb motion">
        	<a href="thread.html"><img src="images/thmbs/threadThmb.png" width="346" height="155" /></a>
             <div class="description">
            	<h3><a href="thread.html">Threadheart Bumper</a></h3>
            </div><!--close description-->
        </div><!--close thmb--> 
        <div class="thmb web">
        	<a href="petunia.html"><img src="images/thmbs/petuniaThmb.jpg" width="346" height="155" /></a>
             <div class="description">
            	<h3><a href="petunia.html">Petunia Golf Resort Web Design</a></h3>
            </div><!--close description-->
        </div><!--close thmb-->    
    </div><!--close thmbContainer-->
